...
export const Payment = ({ amountPaid, hasLoc }: PaymentProps) => {
  const { watch, setValue } = useFormContext();

  const selectedPaymentMode = watch('paymentMethod');
  const loanTotal = amountPaid;
      ...
      <BoxContainer>
        ...
        {selectedPaymentMode === LoanRepaymentMethod?.Account && (
          <Grid templateColumns="repeat(2,1fr)" gap="s20">
            ...
            <FormInput name="account.amount" isDisabled label="Amount" />
        ...
        {selectedPaymentMode === LoanRepaymentMethod?.BankVoucher && (
          <Grid templateColumns="repeat(2,1fr)" gap="s20">
            ...
            <FormInput name="bankVoucher.amount" isDisabled label="Amount" />

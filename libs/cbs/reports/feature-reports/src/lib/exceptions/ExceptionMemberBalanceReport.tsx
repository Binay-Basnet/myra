...
export const ExceptionMemberBalanceReport = () => {
  ...
  return (
    <Report
      ...
      report={ReportEnum.EXCEPTION_MEMBER_WISE_BALANCE}
    >
      <Report.Header>
        <Report.PageHeader
          paths={[
            ...
            {
              label: 'Member Wise Balance Execption Report',
              link: '/cbs/reports/cbs-reports/exceptions/member-wise-balance/new',
            },
          ]}
        />
        <Report.Inputs>

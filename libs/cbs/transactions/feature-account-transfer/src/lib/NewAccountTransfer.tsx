    ...
    <FormLayout methods={methods} hasSidebar={!!memberId}>
          ...
          <Box p="s16" width="100%" display="flex" flexDirection="column" gap="s24">
            <ContainerWithDivider>
              ...
              {srcAccountId && transferType && (
                <BoxContainer>
                  <FormSwitchTab name="withdrawWith" label="Withdraw By" options={withdrawTypes} />
      ...
      <FormLayout.Footer
        mainButton={
            ...
            successCardProps={(response) => {
              ...
              return {
                ...
                details: {
                  ...
                  'Transfer Type': result?.transferType ? transferTypeObj[result.transferType] : '',
          ...
          >
            <Button width="160px">Submit</Button>
          </ResponseDialog>
        }
        status={

  ...
  return (
    ...
    >
      ...
      <Grid alignItems="center" px="s8" py="s12" templateColumns="repeat(3,1fr)" gap="s40">
        ...
        <GridItem>
          <FormNumberInput min={0} name="cashAndCashEquivalentCurrent" />
        </GridItem>
        <GridItem>
          <FormNumberInput min={0} name="cashAndCashEquivalentTarget" />
        </GridItem>
      </Grid>
      <Divider />
      <Grid alignItems="center" px="s8" py="s12" templateColumns="repeat(3,1fr)" gap="s40">
        ...
        <GridItem>
          <FormNumberInput min={0} name="bankCurrent" />
        </GridItem>
        <GridItem>
          <FormNumberInput min={0} name="bankTarget" />
        </GridItem>
      </Grid>
      <Divider />
      <Grid alignItems="center" px="s8" py="s12" templateColumns="repeat(3,1fr)" gap="s40">
        ...
        <GridItem>
          <FormNumberInput min={0} name="investmentsCurrent" />
        </GridItem>
        <GridItem>
          <FormNumberInput min={0} name="investmentsTarget" />
        </GridItem>
      </Grid>
      <Divider />
      <Grid alignItems="center" px="s8" py="s12" templateColumns="repeat(3,1fr)" gap="s40">
        ...
        <GridItem>
          <FormNumberInput min={0} name="loanCurrent" />
        </GridItem>
        <GridItem>
          <FormNumberInput min={0} name="loanTarget" />
        </GridItem>
      </Grid>
      <Divider />
      <Grid alignItems="center" px="s8" py="s12" templateColumns="repeat(3,1fr)" gap="s40">
        ...
        <GridItem>
          <FormNumberInput min={0} name="nonCurrentAssetsCurrent" />
        </GridItem>
        <GridItem>
          <FormNumberInput min={0} name="nonCurrentAssetsTarget" />
        </GridItem>
      </Grid>
      <Divider />
      <Grid alignItems="center" px="s8" py="s12" templateColumns="repeat(3,1fr)" gap="s40">
        ...
        <GridItem>
          <FormNumberInput min={0} name="otherNonCurrentAssetsCurrent" />
        </GridItem>
        <GridItem>
          <FormNumberInput min={0} name="otherNonCurrentAssetsTarget" />
        </GridItem>
      </Grid>
      <Divider />
      {/* .................................last part ............................... */}

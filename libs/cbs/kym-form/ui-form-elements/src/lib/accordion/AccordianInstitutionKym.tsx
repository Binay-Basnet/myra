...
const Decleration: string[] = ['kymInsDocumentsDeclaration', 'kymInsAccountHolderDeclaration'];
...
export const AccorrdianAddInstitution = (props: AccordianProps) => {
  ...
  const [isOpenAccountOperations, setIsOpenAccountOperations] = React.useState(false);

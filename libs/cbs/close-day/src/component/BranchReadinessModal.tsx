...
import { asyncToast, Box, Button, Icon, Input, Loader, Modal, Text } from '@myra-ui';
...
interface IBranchReadinessModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const BranchReadinessModal = ({ isOpen, onClose }: IBranchReadinessModalProps) => {
  ...
  return (
    <Modal open={isOpen} onClose={onClose} isCentered title="All Service Center" width="3xl">

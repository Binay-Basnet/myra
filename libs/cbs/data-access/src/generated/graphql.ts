...
export type SetCooPdirectorDataMutation = {
  members: {
    cooperative?: {
      directorDetails?: { Upsert?: { recordId: string } | null } | null;
    } | null;
  };
};
...
export type DeleteCooPdirectorDataMutation = {
  members: {
    cooperative?: {
      directorDetails?: { Delete?: { recordId: string } | null } | null;
    } | null;
  };
};
...
export type DeletePersonnelDetailsMutation = {
  members: {
    cooperativeUnion?: { deletePersonnel?: { recordId: string } | null } | null;
  };
};
...
export type SetKymDocumentDataMutation = {
...
export type SetSisterConcernsMutation = {
  members: {
    institution?: {
      sisterConcern?: { Upsert?: { recordId: string } | null } | null;
    } | null;
  };
};
...
export type DeleteSisterConcernsMutation = {
  members: {
    institution?: {
      sisterConcern?: { Delete?: { recordId: string } | null } | null;
    } | null;
  };
};
...
export type SetAddDirectorInstitutionMutation = {
  members: {
    institution?: {
      director?: { Upsert?: { recordId: string } | null } | null;
    } | null;
  };
};
...
export type DeleteDirectorInstitutionMutation = {
  members: {
    institution?: {
      director?: { Delete?: { recordId: string } | null } | null;
    } | null;
  };
};
...
export type SetAddAccountOperatorInstitutionMutation = {
  members: {
    institution?: {
      accountOperator?: { Upsert?: { recordId: string } | null } | null;
    } | null;
  };
};
...
export type DeleteAccountOperatorInstitutionMutation = {
  members: {
    institution?: {
      accountOperator?: { Delete?: { recordId: string } | null } | null;
    } | null;
  };
};
...
export type DeleteOptionMutation = {
  settings: {
    form?: { option: { delete: { recordId?: string | null } } } | null;
  };
};
...
export type UpdateCustomSectionFieldMutation = {
  settings: {
    form?: { field: { update: { record?: { id: string } | null } } } | null;
  };
};
...
export type UpdateDeclarationMutation = {
  settings: {
    declaration: {
      update: {
        record?: { content: Record<'local' | 'en' | 'np', string> } | null;
      };
    };
  };
};
...
export type GetBankListQuery = {
  bank: {
    bank?: {
      list?: Array<{ id: string; name?: string | null } | null> | null;
    } | null;
  };
};
        ...
        data?: {
          formData?: {
            ...
            identification?: {
              ...
              citizenshipIssuePlace?: string | null;
              ...
              drivingLicenseIssuePlace?: string | null;
              voterCardNo?: string | null;
              voterPollingStation?: string | null;
            } | null;
            rentedHouse?: {
...
export type GetDeclarationQuery = {
  settings: {
    declaration: {
      get?: {
        data?: { content: Record<'local' | 'en' | 'np', string> } | null;
      } | null;
    };
  };
};

export type GetDepositSettingsIroQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type GetDepositSettingsTdsQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export const useSetDepositIroMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ['setDepositIro'],
    useAxios<SetDepositIroMutation, SetDepositIroMutationVariables>(
      SetDepositIroDocument
    ),
    options
  );
...
export const useSetDepositTdsMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ['setDepositTds'],
    useAxios<SetDepositTdsMutation, SetDepositTdsMutationVariables>(
      SetDepositTdsDocument
    ),
    options
  );
...
>(
  ...
  >(
    ['upsertNewOption'],
    useAxios<UpsertNewOptionMutation, UpsertNewOptionMutationVariables>(
      UpsertNewOptionDocument
    ),
    options
  );
...
export const useDeleteOptionMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ['deleteOption'],
    useAxios<DeleteOptionMutation, DeleteOptionMutationVariables>(
...
export const useMoveOptionMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ['moveOption'],
    useAxios<MoveOptionMutation, MoveOptionMutationVariables>(
      MoveOptionDocument
    ),
    options
  );
...
export const useDeleteFieldMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ['deleteField'],
    useAxios<DeleteFieldMutation, DeleteFieldMutationVariables>(
      DeleteFieldDocument
    ),
    options
  );
...
>(
  ...
  useQuery<GetAccountMemberListQuery, TError, TData>(
    variables === undefined
      ...
      : ['getAccountMemberList', variables],
...
export const useGetMeQuery = <TData = GetMeQuery, TError = unknown>(
  ...
  useQuery<GetMeQuery, TError, TData>(
    ...
    useAxios<GetMeQuery, GetMeQueryVariables>(GetMeDocument).bind(
      null,
      variables
    ),
    options
...
export const useGetBankListQuery = <TData = GetBankListQuery, TError = unknown>(
  ...
  useQuery<GetBankListQuery, TError, TData>(
    ...
    useAxios<GetBankListQuery, GetBankListQueryVariables>(
      GetBankListDocument
    ).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetCoOperativeKymEditDataQuery, TError, TData>(
    ...
    useAxios<
      ...
      GetCoOperativeKymEditDataQueryVariables
    >(GetCoOperativeKymEditDataDocument).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetCoOperativeDirectorEditDataQuery, TError, TData>(
    ...
    useAxios<
      GetCoOperativeDirectorEditDataQuery,
      GetCoOperativeDirectorEditDataQueryVariables
    >(GetCoOperativeDirectorEditDataDocument).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetCooperativeUnionKymEditDataQuery, TError, TData>(
    ...
    useAxios<
      ...
      GetCooperativeUnionKymEditDataQueryVariables
    >(GetCooperativeUnionKymEditDataDocument).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetEconimicDetailsEditDataQuery, TError, TData>(
    ...
    useAxios<
      GetEconimicDetailsEditDataQuery,
      GetEconimicDetailsEditDataQueryVariables
    >(GetEconimicDetailsEditDataDocument).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetBoardOfDirectorsDetailsListQuery, TError, TData>(
    ...
    useAxios<
      GetBoardOfDirectorsDetailsListQuery,
      GetBoardOfDirectorsDetailsListQueryVariables
    >(GetBoardOfDirectorsDetailsListDocument).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetInstitutionKymEditDataQuery, TError, TData>(
    ...
    useAxios<
      ...
      GetInstitutionKymEditDataQueryVariables
    >(GetInstitutionKymEditDataDocument).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetInsBoardDirectorEditListQuery, TError, TData>(
    ...
    useAxios<
      GetInsBoardDirectorEditListQuery,
      GetInsBoardDirectorEditListQueryVariables
    >(GetInsBoardDirectorEditListDocument).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetInsAccountOperatorEditListQuery, TError, TData>(
    ...
    useAxios<
      GetInsAccountOperatorEditListQuery,
      GetInsAccountOperatorEditListQueryVariables
    >(GetInsAccountOperatorEditListDocument).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetInstitutionKymOptionsQuery, TError, TData>(
    ...
    useAxios<
      GetInstitutionKymOptionsQuery,
      GetInstitutionKymOptionsQueryVariables
    >(GetInstitutionKymOptionsDocument).bind(null, variables),
    options
  );
...
>(
  ...
  options?: UseQueryOptions<
    GetIndividualKymIncomeSourceListQuery,
    TError,
    TData
  >
) =>
  useQuery<GetIndividualKymIncomeSourceListQuery, TError, TData>(
    ...
    useAxios<
      GetIndividualKymIncomeSourceListQuery,
      GetIndividualKymIncomeSourceListQueryVariables
    >(GetIndividualKymIncomeSourceListDocument).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetBranchListQuery, TError, TData>(
    ...
    useAxios<GetBranchListQuery, GetBranchListQueryVariables>(
      GetBranchListDocument
    ).bind(null, variables),
    options
  );
...
>(
  ...
  useQuery<GetDeclarationQuery, TError, TData>(
    ...
    useAxios<GetDeclarationQuery, GetDeclarationQueryVariables>(
...
>(
  ...
  useQuery<GetDepositSettingsIroQuery, TError, TData>(
    variables === undefined
      ? ['getDepositSettingsIro']
      : ['getDepositSettingsIro', variables],
...
>(
  ...
  useQuery<GetDepositSettingsTdsQuery, TError, TData>(
    variables === undefined
      ? ['getDepositSettingsTds']
      : ['getDepositSettingsTds', variables],
...
>(
  ...
  useQuery<GetDepositProductSettingsListQuery, TError, TData>(
    ...
    useAxios<
      GetDepositProductSettingsListQuery,
      GetDepositProductSettingsListQueryVariables
    >(GetDepositProductSettingsListDocument).bind(null, variables),
    options
  );

      ...
      valuator?: {
        formState?: {
          data?: {
            ...
            valuationLisenceNo?: string | null;
...
export const useSetValuatorMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ['setValuator'],
    useAxios<SetValuatorMutation, SetValuatorMutationVariables>(
      SetValuatorDocument
    ),
    options
  );
...
export const useGetValuatorQuery = <TData = GetValuatorQuery, TError = unknown>(
  ...
  useQuery<GetValuatorQuery, TError, TData>(
    ...
    useAxios<GetValuatorQuery, GetValuatorQueryVariables>(
      GetValuatorDocument
    ).bind(null, variables),
    options
  );

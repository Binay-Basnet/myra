...
export const useGetMemberClassificationReportQuery = <
    ...
    useQuery<GetMemberClassificationReportQuery, TError, TData>(
      variables === undefined ? ['getMemberClassificationReport'] : ['getMemberClassificationReport', variables],

...
export type GetLoanListQuery = { loanAccount: { list?: { totalCount: number, edges?: Array<{ cursor: string, node?: { id: string, LoanAccountName?: string | null, productType: string, createdAt: string, member: { id: string, name?: Record<"local"|"en"|"np",string> | null, profilePicUrl?: string | null } } | null }> | null, pageInfo?: { endCursor?: string | null, startCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean } | null } | null } };

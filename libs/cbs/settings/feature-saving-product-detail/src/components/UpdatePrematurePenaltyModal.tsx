...
import {
  ...
  useUpdateSavingProductPrematurePenaltyMutation,
...
export const UpdatePrematurePenaltyModal = ({
  isOpen,
  onClose,
  ...
  const { mutateAsync: updatePrematurePenalty } = useUpdateSavingProductPrematurePenaltyMutation();

  const handleSave = () => {
    const values = methods.getValues();

    asyncToast({
      id: 'update-saving-product-premature-penalty',
      msgs: {
...
export default UpdatePrematurePenaltyModal;

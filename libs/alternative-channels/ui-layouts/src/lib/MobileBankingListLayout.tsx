...
export const MobileBankingListLayout = ({ children }: IAccountPageLayoutProps) => {
      ...
      <Box width="260px" flexShrink={0} position="fixed">
        ...
        <Box p="s16">
          <Button
            ...
            onClick={() => router.push('/alternative-channels/activation?type=mBanking')}
          >
            {t['new']}
          </Button>

...
export type GetEbankingLoanAccountsQuery = { eBanking: { loanAccount?: { list?: { accounts?: Array<{ id: string, name: string, productName: string, accountNumber: string, isDefault: boolean, balance: string, interestRate: number } | null> | null } | null } | null } };

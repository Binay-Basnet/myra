...
export const SendOtpForCoopPinResetDocument = `
    mutation sendOtpForCoopPinReset($cooperativeId: ID!, $mobileNumber: String!) {
  eBanking(source: EBANKING) {
    auth {
    ...
    ${MutationErrorFragmentDoc}`;
export const useSendOtpForCoopPinResetMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<Types.SendOtpForCoopPinResetMutation, TError, Types.SendOtpForCoopPinResetMutationVariables, TContext>) =>
    useMutation<Types.SendOtpForCoopPinResetMutation, TError, Types.SendOtpForCoopPinResetMutationVariables, TContext>(
      ['sendOtpForCoopPinReset'],
      useAxios<Types.SendOtpForCoopPinResetMutation, Types.SendOtpForCoopPinResetMutationVariables>(SendOtpForCoopPinResetDocument),
      options
    );
export const ResetCoopPinDocument = `
    mutation resetCoopPin($input: CoopPinResetInput!) {
  eBanking(source: EBANKING) {
    auth {
      resetCoopPin(input: $input) {
        success
        error {
          ...MutationError
        }
    ...
    ${MutationErrorFragmentDoc}`;
export const useResetCoopPinMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<Types.ResetCoopPinMutation, TError, Types.ResetCoopPinMutationVariables, TContext>) =>
    useMutation<Types.ResetCoopPinMutation, TError, Types.ResetCoopPinMutationVariables, TContext>(
      ['resetCoopPin'],
      useAxios<Types.ResetCoopPinMutation, Types.ResetCoopPinMutationVariables>(ResetCoopPinDocument),
      options
    );

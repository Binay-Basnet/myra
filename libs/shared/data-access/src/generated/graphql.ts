...
export type EBankingKymSectionResult =
  | EBankingKymCooperativeMembership
  | EBankingKymDeclaration
  | EBankingKymPersonalInformation
  | EBankingKymProfessionalInformation;
...
export type GetMemberTypesQuery = {
  members: {
    memberTypes: Array<{ id: string; type: KymMemberTypesEnum } | null>;
  };
};
...
export type GetMemberDataQuery = {
  members: {
    individual?: {
      get?: {
        data?: {
...
>(
  ...
  useQuery<GetMemberDataQuery, TError, TData>(
    ...
    useAxios<GetMemberDataQuery, GetMemberDataQueryVariables>(
      GetMemberDataDocument
    ).bind(null, variables),
    options
  );

...
export type SetMemberFamilyDetailsMutation = {
  members: {
    individual?: {
      familyMember: { upsert: { recordId?: string | null } };
    } | null;
  };
};
...
export type DeleteMemberFamilyDetailsMutation = {
  members: {
    individual?: {
      familyMember: { delete: { recordId?: string | null } };
    } | null;
  };
};
...
export type SetMemberOccupationMutation = {
  members: {
    individual?: {
      occupation: { upsert: { recordId?: string | null } };
    } | null;
  };
};
...
export type DeleteMemberOccupationMutation = {
  members: {
    individual?: {
      occupation: { delete: { recordId?: string | null } };
    } | null;
  };
};
...
export type SetMemberIncomeSourceMutation = {
  members: {
    individual?: {
      incomeSource: { upsert: { recordId?: string | null } };
    } | null;
  };
};
...
export type DeleteMemberIncomeSourceMutation = {
  members: {
    individual?: {
      incomeSource: { delete: { recordId?: string | null } };
    } | null;
  };
};
...
export type GetKymDeclarationQuery = {
  settings: {
    kymForm: {
      declaration: {
        id: string;
        content: Record<'local' | 'en' | 'np', string>;
      };
    };
  };
};
...
export const GetIndividualKymOptionDocument = `
    query getIndividualKYMOption($id: String!, $fieldName: String) {
  members {
    individual(id: $id) {
      options {
...
export const GetIndIdentificationDocOptionDocument = `
    query getIndIdentificationDocOption($id: String!) {
  members {
    individual(id: $id) {
      options {
...
>(
  ...
  useQuery<GetIndividualKymEditDataQuery, TError, TData>(
    ...
    useAxios<
      ...
      GetIndividualKymEditDataQueryVariables
    >(GetIndividualKymEditDataDocument).bind(null, variables),
    options
  );

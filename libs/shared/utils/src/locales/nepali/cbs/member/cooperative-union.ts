export const cooperativeUnionNp: Record<string, string> = {
  // cooperative union
  // cooperative union kym form
  // used in accordian and form
  kymCoopUnionAcc1InstitutionInformation: '1. Cooperative union Information',
  ...
  // details of director/boardmembers/partners
  ...
  kymCoopUnionDateOfMembership: 'Date of memberships',
  ...
  // detail of central representative

...
import { Loader, Pagination, TableSearch } from '@myra/dump';
...
export const Table = <T extends Record<string, unknown>>({
  ...
  return (
    ...
    >
      ...
      <TableContainer overflowX="visible" overflowY="visible" position="relative">
        <ChakraTable size={tableSize} overflow="visible" width="100%" {...getTableProps()}>
          <Thead>
            {headerGroups.map((headerGroup) => (
              <Tr {...headerGroup.getHeaderGroupProps()}>
                {headerGroup.headers.map((column: HeaderGroup<T> & ExtraColumnProps) => (
                  <Th
                  ...
                  >
                    ...
                    >
                      ...
                      {column.isSorted ? (
                        ...
                        >
                          {column.isSortedDesc ? (
                            <ArrowUpIcon color="primary.500" fontWeight="bold" w="4" h="6" />
                          ) : (
                            <ArrowDownIcon w="4" h="6" color="primary.500" fontWeight="bold" />
                          )}
                        </Flex>
                      ) : null}
                                ...
                                <PopoverTrigger>
                                  ...
                                  >
                                    {column.filterValue ? (
                                      ...
                                      <Icon as={BiFilter} w="4" h="6" fontWeight="bold" />
                                    )}
                                  </Flex>
                                </PopoverTrigger>
            ...
            <Tfoot>
              {footerGroups.map((footerGroup) => (
                <Tr key={footerGroup.id}>
                  {footerGroup.headers.map((column: HeaderGroup<T> & ExtraColumnProps) => (
                    <Th

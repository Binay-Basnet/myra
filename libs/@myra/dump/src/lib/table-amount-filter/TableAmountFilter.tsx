    ...
    return (
      ...
      >
        <Select
          ...
          ref={ref}
          onChange={(e) => setAmountCondition(e.target.value as AMOUNT_CONDITIONS)}
        >
          <option value={AMOUNT_CONDITIONS.amt_between}>Amount Between ({' <> '})</option>
          <option value={AMOUNT_CONDITIONS.amt_less}>Amount Less Than ({' < '})</option>
          <option value={AMOUNT_CONDITIONS.amt_more}>Amount Greater Than ({' > '})</option>
          <option value={AMOUNT_CONDITIONS.amt_equal}>Amount Equal To ({' = '})</option>
        </Select>
